/**
 * Recurring Management - Sabit rezervasyonlar (web ile uyumlu)
 */
...
type NavProp = StackNavigationProp<RootStackParamList, 'RecurringManagement'>;
...
export default function RecurringManagementScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Icon name="calendar-repeat" size={48} color={colors.primary} style={styles.icon} />
      <Text style={styles.title}>Sabit Rezervasyonlar</Text>
      <Text style={styles.subtitle}>Tekrarlayan rezervasyonlar web ile senkron.</Text>
    </View>
  );
}
