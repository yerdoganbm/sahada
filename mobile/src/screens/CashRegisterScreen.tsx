/**
 * Cash Register - Kasa (web ile uyumlu)
 */
...
type NavProp = StackNavigationProp<RootStackParamList, 'CashRegister'>;
...
export default function CashRegisterScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Icon name="cash-register" size={48} color={colors.primary} style={styles.icon} />
      <Text style={styles.title}>Kasa</Text>
      <Text style={styles.subtitle}>Gunluk kasa islemleri web ile senkron.</Text>
    </View>
  );
}
