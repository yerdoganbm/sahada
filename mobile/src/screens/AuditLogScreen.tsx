/**
 * Audit Log - Denetim kaydi (web ile uyumlu)
 */
...
type NavProp = StackNavigationProp<RootStackParamList, 'AuditLog'>;
...
export default function AuditLogScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Denetim olaylari burada listelenir (web ile senkron).</Text>
    </View>
  );
}
