/**
 * Venue Settings - Saha ayarlari (web ile uyumlu)
 */
...
type NavProp = StackNavigationProp<RootStackParamList, 'VenueSettings'>;
...
export default function VenueSettingsScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Saha Ayarlari</Text>
      <Text style={styles.subtitle}>Genel, fiyatlar ve calisma saatleri web ile senkron.</Text>
    </View>
  );
}
