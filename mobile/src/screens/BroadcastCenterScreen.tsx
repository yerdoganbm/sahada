/**
 * Broadcast Center - Toplu Mesaj (web ile uyumlu)
 */
...
type NavProp = StackNavigationProp<RootStackParamList, 'BroadcastCenter'>;
...
export default function BroadcastCenterScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Icon name="broadcast" size={48} color={colors.primary} style={styles.icon} />
      <Text style={styles.title}>Toplu Mesaj</Text>
      <Text style={styles.subtitle}>Mesaj sablonlari web ile senkron.</Text>
    </View>
  );
}
